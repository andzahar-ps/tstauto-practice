...
public class SelectDropdownListKeywords {
    ...
    @Then("the message returned, displays the values {string} selected by the user")
    public void theMultiSelectListMessageIsDisplayed(String value){
        selectDropdownListSteps.assert_multi_select_list_message(value);
    }
